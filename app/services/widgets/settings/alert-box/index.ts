...
export class AlertBoxService extends WidgetSettingsService<IAlertBoxData> {
  ...
  getApiSettings() {
    return {
      ...
      dataFetchUrl: `https://beta3.${this.getHost()}/api/v5/slobs/widget/alertbox?include_linked_integrations_only=true`,
      settingsSaveUrl: `https://beta3.${this.getHost()}/api/v5/slobs/widget/alertbox`,
